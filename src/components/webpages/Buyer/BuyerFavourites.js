...
const BuyerFavourites = () => {
    ...
    const handleFavouriteRemove = item => {
        ...
        axios
            .patch(`http://localhost:5000/buyers/remove_favourite`, {
                item_id: item._id
            }, {
                headers: {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response_1 = await axios.get('http://localhost:5000/items', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
            const response_2 = await axios.get('http://localhost:5000/buyers/details', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
            const response_3 = await axios.get('http://localhost:5000/vendors', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
